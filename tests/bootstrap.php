 ...
 */
function _lookit_media_master_load_plugin() {
	require dirname( __DIR__ ) . '/lookit-media-master.php';
}
tests_add_filter( 'muplugins_loaded', '_lookit_media_master_load_plugin' );
